...
sort.addEventListener("change", () => {
  ...
  switch (sort.value) {
    case "pages":
      librarySort = libraryOg.sort((a, b) => a.pages - b.pages);
      break;
    case "author":
      librarySort = libraryOg.sort((a, b) => a.author.localeCompare(b.author));
      break;
    case "title":
      librarySort = libraryOg.sort((a, b) => a.title.localeCompare(b.title));
      break;
    default:
      librarySort = [...libraryOg];
  }
